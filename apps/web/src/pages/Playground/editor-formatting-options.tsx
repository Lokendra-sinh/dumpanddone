...
export const EditorFormattingOptionsDropdown = () => {
  const { editor, coords, selectionInfo, setSelectionInfo } = usePlayground();
  const { selectedModel, blogData } = useDashboard();
  ...
  return (
    ...
    >
      {tippyContent &&
        createPortal(
          <div className="sticky z-50 w-[500px] bg-background border rounded-lg shadow-lg overflow-hidden">
