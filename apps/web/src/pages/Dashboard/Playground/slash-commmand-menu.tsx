...
export const SlashCommandMenu = () => {
  ...
  const enhanceTextMutation = trpc.updateBlog.useMutation({
    ...
    onError: (e) => {
      console.log("Error while updating blog is", e.message);
      toast({
    ...
    <>
      {isDropdownOpen && (
        <DropdownMenu open={isDropdownOpen} onOpenChange={setIsDropdownOpen}>
          ...
          >
            {!showAiPreview && 
              <div className="sticky z-50 px-4 py-2 w-[500px] max-h-[500px] rounded-lg overflow-hidden">
                {/* AI Enhance Section */}
      ...
      {/* Dialog is moved outside of DropdownMenuContent */}
